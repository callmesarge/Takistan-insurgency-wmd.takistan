...
// Africian Rebel Army (EAST) 
	...
	_InfPool= 	["O_mas_afr_Soldier_F","O_mas_afr_Soldier_GL_F","O_mas_afr_soldier_AR_F","O_mas_afr_soldier_MG_F","O_mas_afr_Soldier_lite_F", "O_mas_afr_Soldier_off_F","O_mas_afr_Soldier_SL_F","O_mas_afr_Soldier_TL_Fn","O_mas_afr_soldier_M_F","O_mas_afr_soldier_LAT_F","O_mas_afr_soldier_AT_F","O_mas_afr_soldier_LAA_F","O_mas_afr_medic_F","O_mas_afr_soldier_repair_F","O_mas_afr_soldier_exp_F","O_mas_afr_rusadv1_F", "O_mas_afr_rusadv2_F", "O_mas_afr_rusadv3_F"];
        _ArmPool= 	["O_mas_afr_GMG_01_F","O_mas_afr_HMG_01_high_F","O_Truck_02_covered_F"];
        _MotPool= 	["O_mas_afr_Quadbike_01_F", "O_mas_afr_Offroad_01_F", "O_mas_afr_Offroad_01_armed_F", "O_mas_afr_Offroad_01s_F", "O_mas_afr_Offroad_01s_armed_F", "O_mas_afr_Offroad_01c_F", "O_mas_afr_Offroad_01c_armed_F", "O_mas_afr_Truck_02_logistic_F", "O_mas_afr_Truck_02_covered_F","O_mas_afr_Truck_02_transport_F","O_MRAP_02_hmg_F"];
        _ACHPool= 	[];
	_CHPool= 	["O_Heli_Light_02_F", "I_Heli_Transport_02_F","B_Heli_Light_01_armed_F"];
	_uavPool= 	[];
